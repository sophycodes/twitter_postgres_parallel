...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/sophycodes/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/sophycodes/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/sophycodes/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/sophycodes/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/sophycodes/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/sophycodes/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |    23m9.732s              |   2m14.155s               | 
| `pg_normalized_batch`  |    4m27.748s              |   0m12.308s               | 
| `pg_denormalized`      |    0m15.066s              |   0m2.730s                | 
